...
TEST(adt_grid, iotaMap_simple) {
  auto g0 = adt::grid<std_vector, double, 0>(
      typename adt::grid<std_vector, double, 0>::iotaMap(),
      [](auto i) { return double(i); }, 1);
  EXPECT_EQ(0.0, g0.last());
  auto g1 = adt::grid<std_vector, double, 1>(
      typename adt::grid<std_vector, double, 1>::iotaMap(),
...
TEST(adt_grid, fmap2) {
  ...
  auto x0 = adt::grid<std_vector, double, 0>(
      typename adt::grid<std_vector, double, 0>::fmap(),
      [](auto x) { return 2 * x + 1; }, g0);
  auto y0 = adt::grid<std_vector, double, 0>(
      typename adt::grid<std_vector, double, 0>::fmap2(),
  ...
  auto x1 = adt::grid<std_vector, double, 1>(
      typename adt::grid<std_vector, double, 1>::fmap(),
      [](auto x) { return 2 * x + 1; }, g1);
  auto y1 = adt::grid<std_vector, double, 1>(
      typename adt::grid<std_vector, double, 1>::fmap2(),
  ...
  auto x2 = adt::grid<std_vector, double, 2>(
      typename adt::grid<std_vector, double, 2>::fmap(),
      [](auto x) { return 2 * x + 1; }, g2);
  auto y2 = adt::grid<std_vector, double, 2>(
      typename adt::grid<std_vector, double, 2>::fmap2(),
  ...
  auto x3 = adt::grid<std_vector, double, 3>(
      typename adt::grid<std_vector, double, 3>::fmap(),
      [](auto x) { return 2 * x + 1; }, g3);
  auto y3 = adt::grid<std_vector, double, 3>(
      typename adt::grid<std_vector, double, 3>::fmap2(),
  ...
  auto x10 = adt::grid<std_vector, double, 10>(
      typename adt::grid<std_vector, double, 10>::fmap(),
      [](auto x) { return 2 * x + 1; }, g10);
  auto y10 = adt::grid<std_vector, double, 10>(
      typename adt::grid<std_vector, double, 10>::fmap2(),
      [](auto x, auto y) { return x + y; }, g10, x10);
  EXPECT_EQ(3 * (10 * double(s10 - 1)) + 1, y10.last());
}

TEST(adt_grid, fmapTopo) {
  std::ptrdiff_t s = 10;
  ...
  auto x0 = adt::grid<std_vector, double, 0>(
      typename adt::grid<std_vector, double, 0>::fmapTopo(),
      [](auto x) { return 0.0; }, [](auto x, auto i) { return x; }, g0);
  ...
  auto x1 = adt::grid<std_vector, double, 1>(
      typename adt::grid<std_vector, double, 1>::fmapTopo(),
  ...
  auto x2 = adt::grid<std_vector, double, 2>(
      typename adt::grid<std_vector, double, 2>::fmapTopo(),
      [](auto x, auto bm0, auto bp0, auto bm1, auto bp1) {
        return (bm0 - 2.0 * x + bp0) + (bm1 - 2.0 * x + bp1);
      },
      [](auto x, auto i) { return x; }, g2, bm2, bp2, bm2, bp2);
