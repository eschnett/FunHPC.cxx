...
public:
  ...
  double operator()(std::ptrdiff_t i) const
  {
    ...
    return rpc::sync(rpc::remote::sync, vector_t::get_elt_action(),
  ...
  void set_elt(std::ptrdiff_t i, double x)
  {
    auto b = str->find_block(i);
    RPC_ASSERT(has_block(b));
    rpc::sync(rpc::remote::sync, vector_t::set_elt_action(),
              block(b), i - str->block_begin(b), x);
  }
  std::ostream& output(std::ostream& os) const;
...
public:
  ...
  double operator()(std::ptrdiff_t i, std::ptrdiff_t j) const
  {
    ...
    return rpc::sync(rpc::remote::sync,
                     matrix_t::get_elt_action(), block(ib,jb),
