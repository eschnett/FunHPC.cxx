    ...
    template <class _Fp>
        struct __callable<_Fp, true>
        {
            static const bool value =
                is_convertible<typename invoke_of<_Fp&, _ArgTypes...>::type,
                               _Rp>::value;
        };
    template <class _Fp>
...
template<class _Tp> struct is_unique_bind_expression
...
inline 
typename invoke_of<_Ti&, _Uj...>::type
...
struct ____mu_return<_Ti, false, true, false, tuple<_Uj...> >
    : public ____mu_return_invokable<invokable<_Ti&, _Uj...>::value, _Ti, _Uj...>
{
};
...
struct ____mu_return<_Ti, false, false, false, _TupleUj>
{
  ...
  {
    static const bool value = invokable<_Fp,
  ...
  inline 
  typename __unique_bind_return<_Fp, _BoundArgs, _Args>::type
  __apply_unique_functor(_Fp&& __f, _BoundArgs&& __bound_args, __tuple_indices<_Indx...>,
                         _Args&& __args)
  {
  ...
  template<class _Fp, class ..._BoundArgs>
  struct __is_unique_bind_expression<__unique_bind<_Fp, _BoundArgs...> > : public true_type {};
  
  template<class _Rp, class _Fp, class ..._BoundArgs>
  class __unique_bind_r
    : public __unique_bind<_Fp, _BoundArgs...>
  {
  ...
  public:
    ...
    typename enable_if
    <
      is_convertible<typename __unique_bind_return<_Fd, _Td, tuple<_Args&&...> >::type,
                     result_type>::value,
      result_type
      >::type
      operator()(_Args&& ...__args)
    ...
    typename enable_if
    <
      is_convertible<typename __unique_bind_return<const _Fd, const _Td, tuple<_Args&&...> >::type,
                     result_type>::value,
      result_type
      >::type
      operator()(_Args&& ...__args) const
  ...
  template<class _Rp, class _Fp, class ..._BoundArgs>
  struct __is_unique_bind_expression<__unique_bind_r<_Rp, _Fp, _BoundArgs...> > : public true_type {};
  
  template<class _Fp, class ..._BoundArgs>
  inline 
  __unique_bind<_Fp, _BoundArgs...>
  ...
  template<class _Rp, class _Fp, class ..._BoundArgs>
  inline 
  __unique_bind_r<_Rp, _Fp, _BoundArgs...>
  unique_bind(_Fp&& __f, _BoundArgs&&... __bound_args)
  {
