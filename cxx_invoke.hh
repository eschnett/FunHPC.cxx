#ifndef CXX_INVOKE_HH
#define CXX_INVOKE_HH
...
namespace rpc {
  ...
  template <class _Rp, class _Class, class ..._Param>
  struct member_pointer_traits_imp<_Rp (_Class::*)(_Param...) const, true, false>
  {
  ...
  template <class _Rp, class _Class, class ..._Param>
  struct member_pointer_traits_imp<_Rp (_Class::*)(_Param...) volatile, true, false>
  {
  ...
  template <class _Rp, class _Class, class ..._Param>
  struct member_pointer_traits_imp<_Rp (_Class::*)(_Param...) const volatile, true, false>
  {
  ...
  struct member_pointer_traits
    : public member_pointer_traits_imp<typename std::remove_cv<_MP>::type,
  ...
  struct check_complete<_Hp, _T0, _Tp...>
    : private check_complete<_Hp>,
      private check_complete<_T0, _Tp...>
  {
  };
  
  template <class _Hp>
  struct check_complete<_Hp, _Hp>
    : private check_complete<_Hp>
  {
  };
  
  template <class _Tp>
  struct check_complete<_Tp>
  {
  ...
  struct check_complete<_Rp (*)(_Param...)>
    : private check_complete<_Rp>
  {
  };
  
  template <class ..._Param>
  struct check_complete<void (*)(_Param...)>
  {
  };
  ...
  template <class _Rp, class _Class>
  struct check_complete<_Rp _Class::*>
    : private check_complete<_Class>
  {
  };
  ...
  template <class _Fp, class _A0, class ..._Args,
            ...
            <
              std::is_member_function_pointer<typename std::remove_reference<_Fp>::type>::value &&
              std::is_base_of<typename member_pointer_traits<typename std::remove_reference<_Fp>::type>::class_type,
                              typename std::remove_reference<_A0>::type>::value
              >::type
            >
    auto
    invoke(_Fp&& __f, _A0&& __a0, _Args&& ...__args)
  ...
  template <class _Fp, class _A0,
            class = typename std::enable_if
            <
              std::is_member_object_pointer<typename std::remove_reference<_Fp>::type>::value &&
              std::is_base_of<typename member_pointer_traits<typename std::remove_reference<_Fp>::type>::class_type,
                              typename std::remove_reference<_A0>::type>::value
              >::type
            >
    auto
    invoke(_Fp&& __f, _A0&& __a0)
  ...
  template <class _Fp, class ..._Args>
  struct invokable_imp
    : private check_complete<_Fp>
  {
    typedef decltype(
                     invoke(std::declval<_Fp>(), std::declval<_Args>()...)
                     ) type;
  ...
  template <class _Fp, class ..._Args>
  struct invoke_of_imp<true, _Fp, _Args...>
  {
