#ifndef FUN_PAR_DECL_HPP
#define FUN_PAR_DECL_HPP
...
template <typename A, typename B, typename T>
struct fun_traits<adt::par<A, B, T>> {
  template <typename U> using constructor = adt::par<A, B, std::decay_t<U>>;
...
template <typename C, typename F, typename... Args,
          std::enable_if_t<detail::is_par<C>::value> * = nullptr,
...
template <typename F, typename A, typename B, typename T, typename T2,
          typename... Args, typename CT = adt::par<A, B, T>,
...
template <typename F, typename A, typename B, typename T, typename T2,
          typename T3, typename... Args, typename CT = adt::par<A, B, T>,
...
template <typename F, typename Op, typename Z, typename A, typename B,
          typename T, typename... Args, typename CT = adt::par<A, B, T>,
          typename R = cxx::invoke_of_t<F, T, Args...>,
          typename CR = typename fun_traits<CT>::template constructor<R>>
