...
auto matrix_t::faxpy(bool transa, bool transb0, double alpha,
...
auto matrix_t::fgemv(bool trans, double alpha, const vector_t::const_ptr &x,
                     double beta,
...
auto matrix_t::fgemm(bool transa, bool transb, bool transc0, double alpha,
