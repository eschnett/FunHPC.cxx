...
thread_stats_t get_thread_stats() {
  return { thread::threads_started, thread::threads_stopped };
}
...
int thread_main(int argc, char **argv) { return rpc::real_main(argc, argv); }
...
void thread_finalize() { qthread_finalize(); }
}
